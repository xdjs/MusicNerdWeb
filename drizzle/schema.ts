import { pgTable, pgPolicy, bigint, text, boolean, uuid, timestamp, jsonb, numeric, index, uniqueIndex, foreignKey, integer, pgEnum } from "drizzle-orm/pg-core"
...
export const artists = pgTable("artists", {
	id: uuid().default(sql`extensions.uuid_generate_v4()`).notNull(),
