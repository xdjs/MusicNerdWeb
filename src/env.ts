...
// Web search (see webSearch.ts). The vault source search names Exa; everything else uses
// WEB_SEARCH_PROVIDER, Tavily (#1265). An empty key for a provider = that job's searches
