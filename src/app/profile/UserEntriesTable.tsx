    ...
    <Card className="max-w-3xl mx-auto mt-10 border-2 border-[#c6bfc7]">
      ...
      <CardContent className="p-0">
        ...
        <Table className="rounded-md">
          <TableHeader>
            <TableRow className="bg-[#c6bfc7] hover:bg-[#c6bfc7] border-b border-[#9b83a0] rounded-t-md">
              <TableHead
      ...
      {pageCount > 1 && (
        <CardFooter className="bg-[#c6bfc7] border border-[#9b83a0] flex justify-end items-center gap-4 p-3">
          <Button
            variant="outline"
            size="sm"
            disabled={page === 1}
