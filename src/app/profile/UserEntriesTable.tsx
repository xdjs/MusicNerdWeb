      ...
      <Card className="border-2 border-[#9b83a0] shadow-none">
        {/* Mobile: Single scrollable container for header and table */}
            ...
            <div className="bg-[#6f4b75] p-0 rounded-t-md border-b-2 border-[#9b83a0] min-w-full sticky top-0 z-10">
                         <div className="grid grid-cols-[70px_70px_100px_120px_70px_70px] sm:grid-cols-[100px_100px_150px_200px_100px_120px] lg:grid-cols-[1fr_1fr_2fr_2.5fr_0.8fr_1fr] text-white w-full">
              <div
            ...
            {loading ? (
              ...
              (() => {
                ...
                return processed.slice(pageStart, pageEnd).map((entry) => {
                  ...
                  return (
                                         <div key={entry.id} className="grid grid-cols-[70px_70px_100px_120px_70px_70px] sm:grid-cols-[100px_100px_150px_200px_100px_120px] lg:grid-cols-[1fr_1fr_2fr_2.5fr_0.8fr_1fr] bg-white hover:bg-white border-b border-[#9b83a0] w-full">
