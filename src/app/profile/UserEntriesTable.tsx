              ...
              >
                 ...
                 <div className="flex items-center justify-center gap-1 w-full">
                   ...
                   >
                        ...
                        placeholder="Search"
                        ref={artistInputRef}
                        className="h-6 pr-6 pl-2 py-1 text-xs w-15 sm:h-6 sm:pr-6 sm:pl-2 sm:w-full bg-white border border-gray-300 text-black dark:text-white focus:outline-none focus:ring-0 focus:border-gray-300"
                      />
