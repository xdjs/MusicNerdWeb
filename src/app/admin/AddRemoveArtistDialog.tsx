...
import { toggleArtistAction as toggleArtist } from "@/app/actions/serverActions";
import {
  Dialog,
  DialogContent,
  DialogFooter,
...
export function AddRemoveArtistDialog() {
  ...
  async function handleAction() {
    ...
    const resp = await toggleArtist(users);
  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogTrigger asChild>
        <Button variant="outline">Add/Remove Artist</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px] text-black">
        <DialogHeader>
          <DialogTitle>Update Artist Users</DialogTitle>
        </DialogHeader>
