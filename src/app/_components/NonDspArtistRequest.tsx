...
export default function NonDspArtistRequest() {
  ...
  return <details className="group mt-5 border-t border-border pt-4 text-foreground">
    ...
    <div className="mt-4 space-y-4">
      ...
      <a href={draft.href} className="flex min-h-11 items-center justify-center gap-2 rounded-full bg-highlightpink px-4 py-2 text-sm font-semibold text-black hover:opacity-90"><Mail size={16} aria-hidden/>Open email draft</a>
