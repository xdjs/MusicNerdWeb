...
export default async function ArtistProfile({ params, searchParams }: ArtistProfileProps) {
    ...
    // The artist page. While a fresh claim's onboarding runs, the research view
    // takes its place under the app's nav (docs/research-view.md); the gate hands
    // it back when the build finishes or is skipped.
    const profile = (
        <>
