...
// ── UI mocks ──────────────────────────────────────────────────────────────────
// Dialog mock — NO onClick handler so clicks don't bubble and close the modal
...
// Use the real form components so react-hook-form state tracking works correctly
...
// ── Helper ────────────────────────────────────────────────────────────────────
// Gets the "Add Artist" submit button (not the <h2> dialog title)
...
describe('AddArtist', () => {
  ...
  it('submits a valid Spotify URL and calls addArtist', async () => {
    mockSession = { user: { id: 'user-1' } };
    mockAddArtist.mockResolvedValue({ status: 'success', message: 'Artist added!', artistId: 'new-id', artistName: 'New Artist' });
