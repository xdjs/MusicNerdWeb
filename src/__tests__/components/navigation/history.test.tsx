...
jest.mock('@/app/_components/nav/components/SearchBar', () =>
  function MockSearchBar() { return <div data-testid="search-bar" />; }
);
jest.mock('@/app/_components/nav/components/AddArtist', () =>
  function MockAddArtist() { return <div data-testid="add-artist" />; }
);
jest.mock('@/app/_components/nav/components/Login', () =>
  function MockLogin() { return <div data-testid="login" />; }
);
jest.mock('@/app/_components/ThemeToggle', () => ({
  ThemeToggle: function MockThemeToggle() { return <div data-testid="theme-toggle" />; },
}));
jest.mock('next/link', () =>
  function MockLink({ children, href, ...rest }) { return <a href={href} {...rest}>{children}</a>; }
);
